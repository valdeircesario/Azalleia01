...
const ProductsData = [
{
            ...
            img1: '/vestidos/Vestido viscolinho.png',
            img2: '/vestidos/vestido branco.png',
        },
        {
            id: 2,
            icon:'/icom/whatsapp.png',
            ...
            img1: '/vestidos/Vestido alfaiataria.png',
            img2: '/vestidos/Vestido alfaiataria1.png',
        },
        {
            id: 3,
            icon:'/icom/whatsapp.png',
            ...
            price: 'R$179,99',
            installments: '3x de R$59,99',
            img1: '/vestidos/vestido duu.png',
            img2: '/vestidos/vestido duu3.png',
        },
        {
            id: 4,
            icon:'/icom/whatsapp.png',
            ...
            img1: '/vestidos/Vestido tubinho.png',
            img2: '/vestidos/Vestido tubinho1.png',
        },
        {
            id: 5,
            icon:'/icom/whatsapp.png',
            ...
            img1: '/vestidos/vestifocinza1.png',
            img2: '/vestidos/vestifocinza.png',
        },
        {
            id: 6,
            icon:'/icom/whatsapp.png',
            ...
            price: 'Por R$185,25',
            installments: '3x de R$61,75',
            img1: '/vestidos/vestifopreto.png',
            img2: '/vestidos/vestifopreto1.png',
        },
        {
            id: 7,
            icon:'/icom/whatsapp.png',
        ...
        },
        {
            ...
            img1: '/vestidos/vestido branco.png',
            img2: '/vestidos/Vestido elegante todo no linho.png',
        },
        {
            id: 9,
            icon:'/icom/whatsapp.png',
            ...
            price: 'R$179,99',
            installments: '3x de R$58,99',
            img1: '/vestidos/vestido duna.png',
            img2: '/vestidos/vestido duna.png',
        },
        {
            id: 10,
            icon:'/icom/whatsapp.png',
            ...
            img1: '/vestidos/vestidocasual.png',
            img2: '/vestidos/vestidocasual1.png',
        },
        {
            id: 11,
            icon:'/icom/whatsapp.png',
            ...
            installments: '3x de R$58,99',
            img1: '/vestidos/Vestido viscolinho.png',
            img2: '/vestidos/Vestido viscolinho.png',
        },
        {
            id: 12,
            icon:'/icom/whatsapp.png',
